...
- [Working tree currency](working-tree-currency.md): prove and disclose which revision an analysis rests on, and how current it is, before producing conclusions about code.
